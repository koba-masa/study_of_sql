...
ALTER TABLE not_null_when_alter_tables2 ADD COLUMN added_column VARCHAR(32);

SELECT * FROM not_null_when_alter_tables2;

ALTER TABLE not_null_when_alter_tables2 ALTER COLUMN added_column SET NOT NULL;
